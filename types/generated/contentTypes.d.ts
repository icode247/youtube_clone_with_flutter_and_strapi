...
export interface ApiVideoVideo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    likes: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    views: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    comments: Schema.Attribute.Relation<'oneToMany', 'api::comment.comment'>;
    user_likes: Schema.Attribute.Relation<'manyToMany', 'api::video.video'>;
    user_views: Schema.Attribute.Relation<'manyToMany', 'api::video.video'>;
    subscribers: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    user_subscribers: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    createdAt: Schema.Attribute.DateTime;
